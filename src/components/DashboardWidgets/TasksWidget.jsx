  ...
  return (
    <div className="relative border-white border-2 p-6 rounded-2xl shadow-xl flex flex-col justify-between h-full">
      ...
      <Link
        ...
        className="mt-4 inline-flex items-center justify-center w-full lg:w-64 rounded-full bg-gradient-to-r from-indigo-600 to-purple-500 px-4 py-2 text-white shadow-lg transition-all duration-300 hover:bg-opacity-90 dark:from-indigo-500 dark:to-purple-400"
      >
        Aufgaben anzeigen →
      </Link>
    </div>
