      ...
      additionalInfo: (
        <div className="flex items-center space-x-2">
          ...
          {comparisonToLastMonth > 0 ? (
            ...
            <>
              <span> </span> <FaEquals className="text-gray-500" />
            </>
          )}
          <span>
            {comparisonToLastMonth > 0
                ...
                <>
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600">
                      {comparisonToLastMonth !== null ? (
                        item.additionalInfo
                      ) : (
                        <span className="skeleton h-6 w-16 bg-gray-200 rounded animate-pulse"></span>
                      )}
                    </p>
                  </div>
